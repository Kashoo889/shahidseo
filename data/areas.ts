...
export const AREAS: Area[] = [
  ...
  A("business-bay", "Business Bay", "Corporate office clearance and document recycling.", "Specialist commercial logistics for Business Bay — office cleanouts, IT decommissioning and recurring rubbish collection for the district's leading firms.", "1582672060674-bc2bd808a8f5", "Commercial", ["E-Waste Certified", "Out-of-Hours", "Corporate Contracts"]),
  ...
  A("deira", "Deira", "Commercial and residential pickup.", "Deira specialists for shopfront cleanouts, residential pickups and bulk rubbish removal — recurring service contracts available.", "1582672060674-bc2bd808a8f5", "Mixed", ["Shopfront Service", "Recurring Contracts", "Bulk Pickup"]),
  A("bur-dubai", "Bur Dubai", "Heritage area apartment and office pickup.", "Careful, low-impact crews for Bur Dubai's apartments and offices — courteous service and quick same-day slots.", "1582672060674-bc2bd808a8f5", "Mixed", ["Low-Impact", "Quick Slots", "Office Friendly"]),
  ...
  A("dubai-south", "Dubai South", "Residential and commercial pickup.", "Dubai South coverage for villas, apartments and Expo-area businesses — flexible scheduling and bulk capacity available.", "1582672060674-bc2bd808a8f5", "Mixed", ["Flexible Scheduling", "Bulk Capacity", "Commercial Friendly"]),
];
