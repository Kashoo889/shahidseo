...
The three expansion topics approved by the user on 2026-09-19 are written in `data/blog.ts`: garden waste disposal, occupied-office clearance and rental handover decisions. No additional new article is queued. The checklist mapping below remains an existing-page topic.
